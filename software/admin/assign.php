    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="card card-outline card-info">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <input type="text" class="input-group" style="margin: bottom 20px;" placeholder="Title of Annoucement"><br>
          ...
          <div class="col-md-12">
            <div class="card card-default">
              ...
              <div class="card-body">
              <input type="text" class="input-group" style="margin: bottom 20px;" placeholder="Title of Announcment"><br>
