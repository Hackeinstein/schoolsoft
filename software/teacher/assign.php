    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="assign.php" class="nav-link active">
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <div class="card card-outline card-info">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <input type="text" class="input-group" style="margin: bottom 20px;" placeholder="Title of Assigment"><br>
                <textarea id="summernote" style="display: none;"> </textarea><br>
          ...
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Or upload a file</h3>
              </div>
              <div class="card-body">
              <input type="text" class="input-group" style="margin: bottom 20px;" placeholder="Title of Assigment"><br>
